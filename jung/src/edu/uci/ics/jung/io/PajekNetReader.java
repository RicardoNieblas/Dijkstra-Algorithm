...
public class PajekNetReader<G extends Graph<V,E>,V,E>
{
	...
	private SettableTransformer<E, Number> edge_weights =  new  MapSettableTransformer<E, Number>(new HashMap<E, Number>()); 
	private HashMap<E, Number> edge_weights2 = new HashMap<E,Number>();
        ...
        while (br.ready())
        {
            ...
            else // one source, one destination, at most one weight
            {
                ...
                if (edge_weights != null && st.hasMoreTokens()) {
                    ...
                    edge_weights.set(e, value);
                    edge_weights2.put(e, value); // Bad code
                }
            }
        }
        return nextLine;
            ...
            EdgeType directed, Graph<V,E> g, List<V> id, Factory<E> edge_factory)
    {
        ...
        int vid2 = Integer.parseInt(tk.trim()) - 1;
        V v2;
        if (id != null)
          v2 = id.get(vid2);
        else
